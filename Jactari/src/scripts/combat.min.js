...

    {
        ...
        function formulaire_heros(camp){
            ...
            for(var c in _competences_hereditaires)if(_competences_hereditaires[c].combat==1)
                if(hereditaires_pictures){
                    ...
                    html+='<div class="competences-hereditaire" title="'+desc+'"><div id="img-hereditaire'+c+'"/><select id="competence-'+div_id+'">'+options+'</select></div>';
                }else{
        ...
        function formulaire_situation(camp){
            ...
            for(var c in _competences_hereditaires){
                image_css_hereditaire('img-hereditaire'+c, _competences_hereditaires[c], true);
            }
