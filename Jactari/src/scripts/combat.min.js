...
$(document).ready(function(){
    {
        function permalien_combat(){
            ...
            if(attaquant!==undefined)lien+='<br /><a href="'+_traduction.heros[_langue]+'?info='+encode_donnees_heros(attaquant)+'">'+_traduction.heros_attaquant[_langue]+'</a>'+((attaquant.nb_carrieres>3)?_traduction.trop_de_carrieres[_langue]:'');
            if(defenseur!==undefined)lien+='<br /><a href="'+_traduction.heros[_langue]+'?info='+encode_donnees_heros(defenseur)+'">'+_traduction.heros_defenseur[_langue]+'</a>'+((defenseur.nb_carrieres>3)?_traduction.trop_de_carrieres[_langue]:'');
            return lien;
        }
