...
$(document).ready(function(){
    {
        function permalien_combat(){
            ...
            if(attaquant!==undefined)lien+='<br /><a href="'+_traduction.heros_path[_langue]+'?info='+encode_donnees_heros(attaquant)+'">'+_traduction.heros_attaquant[_langue]+'</a>'+((attaquant.nb_carrieres>3)?_traduction.trop_de_carrieres[_langue]:'');
            if(defenseur!==undefined)lien+='<br /><a href="'+_traduction.heros_path[_langue]+'?info='+encode_donnees_heros(defenseur)+'">'+_traduction.heros_defenseur[_langue]+'</a>'+((defenseur.nb_carrieres>3)?_traduction.trop_de_carrieres[_langue]:'');
            return lien;
        }
...
//                        _('xxx');
...

    {
        ...
        function maj_situation(){
            ...
            for(var c in _camps){
                ...
                if($('#heros-'+camp).is(':checked')){
                    ...
                    var multiplicateur=1;
                    if(liste_heros[heros].bonus_legendary_legwarrior_b!==undefined)multiplicateur += liste_heros[heros].bonus_legendary_legwarrior_b/100;
                    if(liste_heros[heros].bonus_legendary_legpaladin_b!==undefined)multiplicateur += liste_heros[heros].bonus_legendary_legpaladin_b/100;
            ...
            // mage hunter
            if(liste_heros[0]!==undefined) {
	            if(liste_heros[0].bonus_legendary_magehunter_a!==undefined && liste_heros[1]!==undefined) {
	            	liste_heros[1].attaque_modifiee -= liste_heros[1].attaque * liste_heros[0].bonus_legendary_magehunter_a / 100;
	            	var bonus_attaque=liste_heros[1].attaque_modifiee-liste_heros[1].attaque;
	            	$('#attaque-heros-defenseur').html(liste_heros[1].attaque+((bonus_attaque>0)?('<span class="plus">+'+formate_nombre(bonus_attaque,0)+'</span>'):((bonus_attaque<0)?('<span class="moins">'+formate_nombre(bonus_attaque,0)+'</span>'):'')));
	            }
	            
	            if(liste_heros[0].bonus_legendary_magehunter_b!==undefined && liste_heros[1]!==undefined) {
	            	liste_heros[1].magie_modifiee -= liste_heros[1].magie * liste_heros[0].bonus_legendary_magehunter_b / 100;
	            	var bonus_m=liste_heros[1].magie_modifiee-liste_heros[1].magie;
	            	$('#magie-heros-defenseur').html(liste_heros[1].magie+((bonus_m>0)?('<span class="plus">+'+formate_nombre(bonus_m,0)+'</span>'):((bonus_m<0)?('<span class="moins">'+formate_nombre(bonus_m,0)+'</span>'):'')));
	            }
            }
            if(liste_heros[1]!==undefined) {
	            if(liste_heros[1].bonus_legendary_magehunter_a!==undefined && liste_heros[0]!==undefined) {
	            	liste_heros[0].attaque_modifiee -= liste_heros[0].attaque * liste_heros[1].bonus_legendary_magehunter_a / 100;
	            	var bonus_attaque=liste_heros[0].attaque_modifiee-liste_heros[0].attaque;
	            	$('#attaque-heros-attaquant').html(liste_heros[0].attaque+((bonus_attaque>0)?('<span class="plus">+'+formate_nombre(bonus_attaque,0)+'</span>'):((bonus_attaque<0)?('<span class="moins">'+formate_nombre(bonus_attaque,0)+'</span>'):'')));
	            }
	            
	            if(liste_heros[1].bonus_legendary_magehunter_b!==undefined && liste_heros[0]!==undefined) {
	            	liste_heros[0].magie_modifiee -= liste_heros[0].magie * liste_heros[1].bonus_legendary_magehunter_b / 100;
	            	var bonus_m=liste_heros[0].magie_modifiee-liste_heros[0].magie;
	            	$('#magie-heros-attaquant').html(liste_heros[0].magie+((bonus_m>0)?('<span class="plus">+'+formate_nombre(bonus_m,0)+'</span>'):((bonus_m<0)?('<span class="moins">'+formate_nombre(bonus_m,0)+'</span>'):'')));
	            }
            }
        ...
        function formulaire_heros(camp){
            ...
            // switch for use old/new style, temporary decision
            var hereditaires_pictures = true;
            for(var c in _competences_hereditaires)if(_competences_hereditaires[c].combat==1)
                if(hereditaires_pictures){
                    var div_id='hereditaire-'+c+'-'+camp;
                    var title=_competences_hereditaires[c].nom[_langue];
                    var desc=title;
                    if (_competences_hereditaires[c].description[_langue])
                        desc+='\n\n'+_competences_hereditaires[c].description[_langue];
                    html+='<div class="competences-hereditaire" title="'+desc+'"><div id="img-hereditaire'+c+'-'+camp+'"/><select id="competence-'+div_id+'">'+options+'</select></div>';
                }else{
            ...
            html+='</div>';
            html+='<br />';
            html+='<div style="text-align:left;"><input id="legendary-classes-' + camp + '" type="button" value="' + _traduction.legendary_classes[_langue] + '" /></div>';
        ...
        function formulaire_situation(camp){
            ...
            /* Set images for hereditaires */
            for(var c in _competences_hereditaires){
                image_css_hereditaire('img-hereditaire'+c+'-' + camp, _competences_hereditaires[c], true);
            }
