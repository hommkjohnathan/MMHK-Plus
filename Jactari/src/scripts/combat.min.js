...

    {
        ...
        function maj_situation(){
            ...
            if(liste_heros[1]!==undefined) {
	            if(liste_heros[1].bonus_legendary_magehunter_a!==undefined && liste_heros[1]!==undefined) {
	            ...
	            if(liste_heros[1].bonus_legendary_magehunter_b!==undefined && liste_heros[1]!==undefined) {
