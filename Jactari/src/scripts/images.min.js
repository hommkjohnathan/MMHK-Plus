...
if(_page=='combat')_images=_images.concat(images.creatures_combat,images.combat_sorts);
...
function image_css_heros(id_image,faction,visage){
    ...
    $('#'+id_image).attr('alt','portrait numéro '+visage+' de la faction '+_factions[faction].nom[_langue])
};
