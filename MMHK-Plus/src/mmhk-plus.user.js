...
// @author          Aendawyn
// @version         3.1.2
// @description     Ajout de fonctionnalités pour Might & Magic : Heroes Kingdoms
...
var MMHKPLUS = {};
MMHKPLUS.version = "3.1.2";
MMHKPLUS.contact = "aendawyn@gmail.com";
MMHKPLUS.HOMMK = window.HOMMK;
MMHKPLUS.locale = "fr";
MMHKPLUS.URL = "http://www.mmhk-plus.net";
MMHKPLUS.URL_RESOURCES = MMHKPLUS.URL + "/script";
...
MMHKPLUS.css = [
	...
	// Jactari
	'#permalien_jactari:hover{} #permalien_jactari { font-size:smaller; background-color:beige; padding-left: 26px; position: absolute; top: 50px; left: 320px; width: 65px; border: solid black 1px; background-repeat:no-repeat; height: 16px; background-image: url(http://jactari.mmhk-plus.com/images/icone-combat.png); z-index: 1000; }',
	'#permalien_jactari_defencer:hover{} #permalien_jactari_defencer { font-size:smaller; background-color:beige; padding-left: 26px; position: absolute; top: 50px; left: 320px; width: 65px; border: solid black 1px; background-repeat:no-repeat; height: 16px; background-image: url(http://jactari.mmhk-plus.com/images/icone-combat.png); z-index: 1000; }',
	...
	".MMHKPLUS_KingdomHeroesArtifactsBg { background-image : url(" + MMHKPLUS.URL_RESOURCES + "/images/kingdom/background_artefacts.png); background-repeat:no-repeat; background-position:0px 0px; padding-left:30px; width:350px; height:47px; color:#FFFFFF; line-height:47px; margin:5px; }",
    ...
    // $.getScript("http://hommknav.fr/mmhk-plus/check_update.php", function(e)
        {
            ...
            if(need)
            {
                ...
                if(!hasProperty(window, "chrome"))
                    $("<p><a class='MMHKPLUS_Link' href='" + "http://www.mmhk-plus.net/script/download.php?.user.js" + "' target='_blank' style='font-size:140%;'>" + MMHKPLUS.localize("DOWNLOAD") + "</a></p>").addClass("center").appendTo(panel);
                panel.dialog(
                    {
                        autoOpen : false,
...
MMHKPLUS.EnhancedUI = MMHKPLUS.ExtendableElement.extend({
	...
	_setupCenterOn : function()
	{
		...
		$("<input maxlength='3' style='width:35px;'>").appendTo($container);
		$("<div>").button()
			.css({height : "20px", width : "55px", marginLeft : "10px", marginTop : "3px", lineHeight : "20px"})
