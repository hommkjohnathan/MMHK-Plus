MMHKPLUS.translations = {
    ...
    D_DISTANCES :  	{fr : "Afficher la distance des villes", en : "Display distance from cities", ru : "[en] Display distance from cities"},
    D_REQUEST :  	{fr : "Afficher l'indicateur de requêtes", en : "Display request indicator", ru : "[en] Display request indicator"},
    D_PLAYERCHAT :  {fr : "Colorer les messages du joueur dans le chat", en : "Color player messages in chat", ru : "[en] Color player messages in chat"},
    D_RESOURCES :  	{fr : "Afficher les mines des régions", en : "Display region mines", ru : "[en] Display region mines"},
