MMHKPLUS.translations = {
    ...
    SCOUT : 		{fr : "Reco", en : "Scout", ru : "Разведывает"},
    DECOY : 		{fr : "Leurre", en : "Decoy", ru : "Заманивает"},
    FRIDGE : 		{fr : "Frigo", en : "Fridge", ru : "Заморожен"},
    ATTACK : 		{fr : "Attaque", en : "Attack", ru : "Атакует"},
    SETTLE : 		{fr : "Coloniser", en : "Settle", ru : "Заселяет"},
    PILLAGE : 		{fr : "Piller", en : "Pillage", ru : "Грабит"},
    ...
    WS_MESSAGE : 	{fr : "Voulez-vous changer de monde?", en: "Do you want to switch world?", ru:"Перейти в другой мир?"},
	...
	ALLIANCE_STATISTICS : {fr : "Statistiques", en : "Statistics", ru : "статистика"},
