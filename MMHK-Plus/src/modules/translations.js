MMHKPLUS.translations = {
    ...
    LAST_UPDATE : 	{fr : "Dernière mise à jour", en : "Last update", ru : "[en] Last update"},
    ALLIANCE_MEMBERS:{fr : "Membres de l'alliance", en : "Alliance members", ru : "[en] Alliance members"},
    ALLIANCE_TOP10 :{fr : "Top 10 Alliances", en : "Alliances Top 10", ru : "[en] Alliances Top 10"},
    PVP_XP : 		{fr : "XP PvP", en : "PvP XP", ru : "[en] PvP XP"},
    TERRITORY_SCORE:{fr : "Score taille territoire", en : "Territory size score", ru : "[en] Territory size score"},
    GRAIL_SCORE : 	{fr : "Score structures Graal", en : "Grail structures score", ru : "[en] Grail structures scor"},
    RUNIC_SCORE : 	{fr : "Score forteresses runiques", en : "Runic fortresses score", ru : "[en] Runic fortresses score"},
    MEMBERS : 		{fr : "Membres", en : "Members", ru : "[en] Members"},
    CITIES_SCORE : 	{fr : "Score cités capturées", en : "Captured cities score", ru : "[en] Captured cities score"},
    PILLAGE_SCORE : {fr : "Score ressources pillées", en : "Pillage resources score", ru : "[en] Pillage resources score"},
