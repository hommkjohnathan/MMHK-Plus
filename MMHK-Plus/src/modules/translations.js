MMHKPLUS.translations = {
	// Commun
	DAY :			{fr : "Jour", en : "Day", ru : "День", de : "Tag"},
	HOUR :			{fr : "Heure", en : "Hour", ru : "Час", de : "Stunde"},
	MINUTE :		{fr : "Minute", en : "Minute", ru : "Минута", de : "Minute"},
	SECONDE :		{fr : "Seconde", en : "Second", ru : "Секунда", de : "Sekunde"},
	DAY_SMALL :		{fr : "j", en : "d", ru : "д", de : "t"},
	HOUR_SMALL :	{fr : "h", en : "h", ru : "ч", de : "h"},
	MINUTE_SMALL :	{fr : "m", en : "m", ru : "м", de : "m"},
	SECOND_SMALL :	{fr : "s", en : "s", ru : "с", de : "s"},
    YES:            {fr : "Oui", en : "Yes", ru : "Да", de: "Ja"},
    NO:             {fr : "Non", en : "No", ru : "Нет", "Nein"},
    CLOSE:          {fr : "Fermer", en : "Close", ru : "Закрыть", de : "Schließen"},
    DOWNLOAD:       {fr : "Téléchargement", en : "Download", ru : "Загрузка", de : "Download"},
    RUIN :          {fr : "Ruine", en : "Ruin", ru : "Сбой скрипта", de : "Ruine"},

    // Update
    UPDATE_TITLE :  {fr : "Mise à jour", en : "Update", ru : "Обновление", de : "Aktualisierung"},
    UPDATE_TEXT  :  {fr : "Une mise à jour est disponible. Rendez-vous sur le site web du script pour l'obtenir.", 
                     ...
                     de : "Eine Aktualisierung ist auf der Webseite des Skripts verfügbar."},

	// EnhanceUi
	CENTER :		{fr : "Centrer", en : "Go to", ru : "Перейти в", de : "Gehe zu"},
    IN_PROGRESS :   {fr : "En cours...", en : "In progress...", ru : "Подождите...", de : "Arbeite..."},
    CHECK :         {fr : "Cocher", en : "Check", ru : "Выделить", de : "Ankreuzen"},
    FROM_MSG :      {fr : "De", en : "From", ru : "Из", de : "Von"},
    TO_MSG :        {fr : "À", en : "To", ru : "В", de : "An"},
    SCOUT : 		{fr : "Reco", en : "Scout", ru : "Разведывает", de : "Ausspähen"},
    DECOY : 		{fr : "Leurre", en : "Decoy", ru : "Заманивает", de : "Täuschen"},
    FRIDGE : 		{fr : "Frigo", en : "Fridge", ru : "Заморожен", de : "Eisschrank"},
    ATTACK : 		{fr : "Attaque", en : "Attack", ru : "Атакует", de : "Angreifen"},
    SETTLE : 		{fr : "Coloniser", en : "Settle", ru : "Заселяет", de : "Besiedeln"},
    PILLAGE : 		{fr : "Piller", en : "Pillage", ru : "Грабит", de : "Plündern"},
    LOCAL :  		{fr : "Local", en : "Local", ru : "Лок. ", de : "Lokal"},
    SERVER :  		{fr : "Server", en : "Server", ru : "Серв. ", de : "Server"},
	
	// Store
	QUOTA_REACHED :		{fr : "Quota de stockage atteint", en : "Storage quota reached", 
				ru : "Заполнено место хранения данных", de : "Speicherlimit erreicht"},
	QUOTA_REACHED_TEXT :{fr : "Veuillez supprimer des données via le menu <i>Options</i>.<br/><br/> \
						 ...
						 de : "Bitte löschen Sie einige Daten im Menü <i>Optionen</i>.<br/><br/> \
						 		Falls das Problem weiter besteht, löschen Sie Ihren Browsercache \
						 		<i>(löscht Ihre Einstellungen)</i>"},

    // WorldSwitch
	RESET : 		{fr : "Réinitialiser", en : "Reset", ru : "Очистить", de : "Neu initialisieren"},
    CONFIRM :       {fr : "Confirmer", en : "Confirm", ru : "Подтвердите", de : "Bestätigen"},
    CONFIRM_TEXT :  {fr : "Confirmez-vous la remise à zéro?", en : "Do you confirm reset?", ru : "Очистить список?", de : "Wirklich alles zurücksetzen?"},
    OK :            {fr : "Ok", en : "Ok", ru : "Да", de : "Ok"},
    CANCEL :        {fr : "Annuler", en : "Cancel", ru : "Нет", de : "Abbrechen"},
    WS_MESSAGE : 	{fr : "Voulez-vous changer de monde?", en: "Do you want to switch world?", ru:"Перейти в другой мир?", de : "Wollen Sie die Welt wechseln?"},

	// Menu
	ALLIANCE : 		{fr : "Alliance", en : "Alliance", ru : "Альянс", de : "Bündnis"},
	KINGDOM : 		{fr : "Royaume", en : "Kingdom", ru : "Королевство", de : "Königreich"},
	TOOLS : 		{fr : "Outils", en : "Tools", ru : "Инструменты", de : "Werkzeuge"},
	OPTIONS : 		{fr : "Options", en : "Options", ru : "Опции", de: "Optionen"},
	
    ONLINE_MEMBERS :{fr : "Membres en ligne", en : "Online members", ru : "Игроки онлайн", de : "Mitglieder Online"},
	ALLIANCE_SPYS : {fr : "Rapports", en : "Reports", ru : "Отчеты разведки", de : "Berichte"},
	ALLIANCE_HEROES:{fr : "Héros", en : "Heroes", ru : "Герои", de : "Helden"},
	ALLIANCE_STATISTICS : {fr : "Statistiques", en : "Statistics", ru : "статистика", de : "Statistik"},
	ARMIES : 		{fr : "Armées", en : "Armies", ru : "Войска", de : "Armeen"},
	RECRUITMENT : 	{fr : "Recrutement", en : "Recruitment", ru : "Найм существ", de : "Anwerbung"},
	RESOURCES : 	{fr : "Ressources", en : "Resources", ru : "Ресурсы", de : "Resourcen"},
	HEROES : 		{fr : "Héros", en : "Heroes", ru : "Герои", de : "Helden"},
	ARTIFACTS : 	{fr : "Artéfacts", en : "Artifacts", ru : "Артефакты", de : "Artefakte"},
	ACTIONS : 		{fr : "Actions", en : "Actions", ru : "Действия", de : "Aktionen"},
	HEROES_SPELLS : {fr : "Sorts (héros)", en : "Spells (heroes)", ru : "Заклинания у героев", de : "Zauber (Helden)"},
	CITIES_SPELLS : {fr : "Sorts (villes)", en : "Spells (cities)", ru : "Заклинания в городах", de : "Zauber(Städte)"},
    CITIES_BUILDINGS :{fr : "Bâtiments", en : "Buildings", ru : "Постройки в городах", de : "Gebäude"},
    REGIONS :       {fr : "Régions", en : "Regions", ru : "Постройки в регионах", de : "Regionen"},
    ATTACKS_SIEGES :{fr : "Sièges", en : "Sieges", ru : "Осады", de : "Belagerungen"},
	LOOKOUT : 		{fr : "Vigie", en : "Lookout", ru : "Наблюдение", de : "Wacht"},
	MINEFINDER : 	{fr : "MineFinder", en : "MineFinder", ru : "Поиск ресурсов", de : "Bergwerksfinder"},
	CARTO : 		{fr : "Cartographe", en : "Cartographer", ru : "Карта мира", de : "Kartograf"},
	DISTANCES : 	{fr : "Distances", en : "Distances", ru : "Расстояния", de : "Entfernungen"},
	MARKS : 		{fr : "Repères", en : "Marks", ru : "Пометки", de : "Schilder"},
	NOTEPAD : 		{fr : "Bloc-notes", en : "Notepad", ru : "Блокнот", de : "Notizblock"},
	ABOUT : 		{fr : "A propos de", en : "About", ru : "О программе", de : "Über"},
    ...
    // AllianceStatistics
    WORLD : 		{fr : "Monde", en : "World", ru : "Вселенная"},
    ADMINISTRATION :{fr : "Administration", en : "Administration", ru : "Управление"},
    COLLECT : 		{fr : "Collecter", en : "Collect", ru : "Сбор данных"},
    RANKING : 		{fr : "Classement", en : "Ranking", ru : "Рейтинг"},
    SCORE : 		{fr : "Score", en : "Score", ru : "Очки"},
    CITIES_COUNT : 	{fr : "Nombre de cités", en : "Number of cities", ru : "количество городов"},
    LAST_UPDATE : 	{fr : "Dernière mise à jour", en : "Last update", ru : "Последнее обновление"},
    ALLIANCE_MEMBERS:{fr : "Membres de l'alliance", en : "Alliance members", ru : "Члены альянса"},
    ALLIANCE_TOP10 :{fr : "Top 10 Alliances", en : "Alliances Top 10", ru : "10 лучших альянсов"},
    PVP_XP : 		{fr : "XP PvP", en : "PvP XP", ru : "Опыт, полученный в PVP боях"},
    TERRITORY_SCORE:{fr : "Score taille territoire", en : "Territory size score", ru : "Размер территории"},
    GRAIL_SCORE : 	{fr : "Score structures Graal", en : "Grail structures score", ru : "Строения Грааля"},
    RUNIC_SCORE : 	{fr : "Score forteresses runiques", en : "Runic fortresses score", ru : "Доход от рунных крепостей"},
    MEMBERS : 		{fr : "Membres", en : "Members", ru : "Игроки"},
    CITIES_SCORE : 	{fr : "Score cités capturées", en : "Captured cities score", ru : "Захваченные города"},
    PILLAGE_SCORE : {fr : "Score ressources pillées", en : "Pillage resources score", ru : "Разграбления"},
	...
	READY_IN :		{fr : "Prêt dans", en : "Ready in", ru : "Время до готовности"},
    ...
    SEARCH :		{fr : "Chercher", en : "Search", ru : "Искать"},
    ...
    D_DISTANCES :  	{fr : "Afficher la distance des villes", en : "Display distance from cities", ru : "Отображать расстояние от городов"},
    D_REQUEST :  	{fr : "Afficher l'indicateur de requêtes", en : "Display request indicator", ru : "Отображать индикатор запроса"},
    D_PLAYERCHAT :  {fr : "Colorer les messages du joueur dans le chat", en : "Color player messages in chat", ru : "Окрашенные сообщения игрока в чате"},
    D_RESOURCES :  	{fr : "Afficher les mines des régions", en : "Display region mines", ru : "Отображать шахты в регионе"},
